  ...
  return (
    <article>
      ...
      <div className="space-y-7 text-sm leading-relaxed text-muted">
        <section>
          <h2 className="mb-2 font-display text-lg font-bold text-fg">7-din no-questions refund</h2>
        ...
        <section>
          <h2 className="mb-2 font-display text-lg font-bold text-fg">Coin packs</h2>
          <p>Coins redeem hone se pehle (payment ke 48h andar) full refund. Redeemed coins refundable nahi.</p>
        </section>
        <section>
          <h2 className="mb-2 font-display text-lg font-bold text-fg">Duplicate charge</h2>
          <p>Doo dafa kat gaya? Ghabrao nahi — screenshot ke sath email karein, 24h mein duplicate wapas.</p>
        </section>
        <section>
          <h2 className="mb-2 font-display text-lg font-bold text-fg">Cancellation</h2>
