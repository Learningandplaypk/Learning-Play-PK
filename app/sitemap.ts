...
export default function sitemap(): MetadataRoute.Sitemap {
  const now = new Date();
  const staticRoutes = ["", "/learn", "/brain", "/quiz", "/fun", "/leaderboard", "/profile", "/premium", "/shop", "/progress", "/account", "/downloads", "/mistakes","/blog", "/about", "/contact", "/privacy", "/terms", "/refund-policy", "/login", "/signup", "/forgot",
  ];
